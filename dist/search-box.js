...
(function() {
  var $, ENTER, ESC, SearchBox, exports, jQuery, match,
  ...
  SearchBox = (function() {
    ...
    SearchBox.prototype.close = function() {
      ...
      this.root.toggleClass("is-open", this.isOpen);
      this.items.show();
      return this.searchField.val("").blur();
    };
